...
const AnoAI = () => {
  ...
  useEffect(() => {
    ...
    // Set a fixed aspect ratio for the camera to prevent distortion from default window size
    ...
    let frameId: number; // Declare frameId for cancellation
    const animate = () => {
    ...
    return () => {
      ...
      if (container) { // Check if container is still valid before removing child
